...
class _$ResultTearOff {
  ...
  _Success<T, E> success<T, E extends NetworkError>(T data) {
    return _Success<T, E>(
      data,
    );
  }

  _Failure<T, E> failure<T, E extends NetworkError>(E error) {
    return _Failure<T, E>(
      error,
    );
  }
...
/// @nodoc
mixin _$Result<T, E extends NetworkError> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $ResultCopyWith<T, E extends NetworkError, $Res> {
...
/// @nodoc
class _$ResultCopyWithImpl<T, E extends NetworkError, $Res>
...
/// @nodoc
abstract class _$SuccessCopyWith<T, E extends NetworkError, $Res> {
...
/// @nodoc
class __$SuccessCopyWithImpl<T, E extends NetworkError, $Res>
...
class _$_Success<T, E extends NetworkError> implements _Success<T, E> {
...
abstract class _Success<T, E extends NetworkError> implements Result<T, E> {
...
/// @nodoc
abstract class _$FailureCopyWith<T, E extends NetworkError, $Res> {
...
/// @nodoc
class __$FailureCopyWithImpl<T, E extends NetworkError, $Res>
    extends _$ResultCopyWithImpl<T, E, $Res>
...
class _$_Failure<T, E extends NetworkError> implements _Failure<T, E> {
...
abstract class _Failure<T, E extends NetworkError> implements Result<T, E> {
